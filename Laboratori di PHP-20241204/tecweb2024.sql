...
-- Versione PHP: 7.1.23
/*Come connettersi da PC laboratorio: guarda https://www.studenti.math.unipd.it/tecweb/ una volta sul programma fai ls e  nano pwd_db_2024-25.txt
per avere la password. poi vai su http://tecweb.studenti.math.unipd.it/phpmyadmin e fai l'accesso. poi vai su importa e seleziona il file .sql cambiano il campo USE con il tuo username*/
